...
import { availabilityZone, cidr, optional, region, enumType, parse } from '@aws-accelerator/common-types';
...
export const CentralServicesConfigType = t.interface({
  ...
  'ssm-to-s3': fromNullable(t.boolean, false),
  'ssm-to-cwl': fromNullable(t.boolean, false),
